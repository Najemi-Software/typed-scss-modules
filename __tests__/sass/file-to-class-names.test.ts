...
describeAllImplementations((implementation) => {
    describe("fileToClassNames", () => {
        it("converts a file path to an array of class names (default camel cased)", async () => {
            const result = await fileToClassNames(`${import.meta.dirname}/../dummy-styles/complex.scss`);
        ...
        describe("nameFormat", () => {
            ...
            it("converts a file path to an array of class names where only classes with dashes in the names are altered", async () => {
                const result = await fileToClassNames(`${import.meta.dirname}/../dummy-styles/dashes.scss`, {
                    nameFormat: ["dashes"],
                    implementation,
                });
        ...
        describe("aliases", () => {
            it("converts a file that contains aliases", async () => {
                const result = await fileToClassNames(`${import.meta.dirname}/../dummy-styles/aliases.scss`, {
                    aliases: {
