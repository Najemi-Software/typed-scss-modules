...
const classNameToNamedTypeDefinition = (className: ClassName) => `export declare const ${className}: string;`;
...
const isReservedKeyword = (className: ClassName) =>
    reserved.check(className, "es5", true) || reserved.check(className, "es6", true);
