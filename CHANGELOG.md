...
- Improve typings for param of internal type CbFunc (`any[]` -> `never[]`)

## [14.3.0] - 2026-07-15

### Changed

- Improve typings for param of function getImplementation
...
- Bad self-referencing import path in `core/types` (`../core/alerts.js` -> `./alerts.js`)

## [14.1.0] - 2026-07-15

### Changed

- Explicitly discard (`void`) the results of fire-and-forget `writeFile` calls in watch mode (no behavior change)
- Remove the unused internal `SASSAsyncImporter` type alias (was never part of the public API)
...
- Make Typescript config stricter

## [13.10.0] - 2026-07-15

### Changed

- Delete embedded tsconfig.json files
...
[13.11.0]: https://github.com/Najemi-Software/typed-scss-modules/compare/v13.10.0...v13.11.0
[13.10.0]: https://github.com/Najemi-Software/typed-scss-modules/compare/v13.9.0...v13.10.0
[13.9.0]: https://github.com/Najemi-Software/typed-scss-modules/compare/v13.8.0...v13.9.0
[13.8.0]: https://github.com/Najemi-Software/typed-scss-modules/compare/v13.7.0...v13.8.0
[13.7.0]: https://github.com/Najemi-Software/typed-scss-modules/compare/v13.6.0...v13.7.0
[13.6.0]: https://github.com/Najemi-Software/typed-scss-modules/compare/v13.5.0...v13.6.0
[13.5.0]: https://github.com/Najemi-Software/typed-scss-modules/compare/v13.4.0...v13.5.0
